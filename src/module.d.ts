...
interface QueryTaxiway {
    "name": string,
    "coordinates": number[]
}

interface QueryAirway {
    'ident': string,
    'lnglats': number[][],
    'start': string,
    'end': string
