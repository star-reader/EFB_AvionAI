    ...
    return (
        ...
        <div className="fixed left-0 right-0 top-0 bottom-0 z-[42]">
            <div className="absolute w-[300px] h-[130px] z-[50] t-calc-50-minus-50px-2 
                ...
                spin />
                <div className="relative w-full text-center text-white text-[20px] mt-3 select-none">Analyzing route ...</div>
                <div className="relative w-[80%] left-[10%] mt-[3px]">
                    {
                        isFail && <span className="text=[17px] text-center text-red-500 select-none" onClick={() => setIsShow(false)}>failed to load flight, please click to try again</span>
                    }
                </div>
            </div>
        </div>
