    ...
    return (
        ...
        <div className="fixed w-full h-full left-0 top-0 duration-500 z-[40] bg-[rgba(0,0,0,0.25)]">
            ...
            animation: 'loadingPopUp 0.3s'}}>
                ...
                select-none">Runway Selection</div>
                <div className="relative text-[14px] text-center text-white mb-3 mt-1 flex justify-around select-none">
                    <div className="relative w-[13%]">Ident</div>
                    <div className="relative w-[13%]">Up wind</div>
                    <div className="relative w-[13%]">Cross wind</div>
                    <div className="relative w-[13%]">Heading</div>
                    <div className="relative w-[13%]">Length</div>
                    <div className="relative w-[13%]">Width</div>
                    <div className="relative w-[13%]">Elevation</div>
                </div>
                ...
                onClick={handleClose}>Cance Selection</div>
            </div>
        </div>
        </>
    )
