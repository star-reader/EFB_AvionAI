    ...
    return (
        ...
        <div className="fixed w-full h-full left-0 top-0 duration-500 z-[40] bg-[rgba(0,0,0,0.25)]">
            ...
            animation: 'loadingPopUp 0.3s'}}>
                ...
                select-none">Approach Procedure Selection</div>
                <div className="relative text-[14px] text-center text-white mb-3 mt-1 flex justify-around select-none">
                    ...
                    <div className="relative w-[18%]">Arrival airport</div>
                    <div className="relative w-[18%]">Approach procedure</div>
                    <div className="relative w-[18%]">Transaction</div>
                    <div className="relative w-[18%]">Landing runway</div>
                </div>
