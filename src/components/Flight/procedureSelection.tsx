    ...
    return (
        ...
        <div className="fixed w-full h-full left-0 top-0 duration-500 z-[40] bg-[rgba(0,0,0,0.25)]">
            ...
            animation: 'loadingPopUp 0.3s'}}>
                ...
                select-none">{selectionType === 'sid' ? 'Depeature' : 'Arrival'}Procedure Selection</div>
                <div className="relative text-[14px] text-center text-white mb-3 mt-1 flex justify-around select-none">
                    <div className="relative w-[23%]">{selectionType === 'sid' ? 'Departure' : 'Arrival'} Airport</div>
                    <div className="relative w-[23%]">Procedure name</div>
                    <div className="relative w-[23%]">Runway</div>
                    <div className="relative w-[23%]">Transition</div>
                </div>
                <div className="relative w-full h-[270px] mt-2 overflow-x-hidden overflow-y-auto">
                    ...
                    pt-1 pb-1 bg-[rgb(53,84,114)] select-none">
                        <span className='mr-2 font-bold text-[15px]'>Recommend{selectionType === 'sid' ? ' SID' : ' STAR'}</span>
                        <span className='text-[14px] text-white leading-4'>Runway、{selectionType === 'sid' ? 'Departure ' : 'Arrival '}Point are both fit</span>
                    </div>
                    {
                        recommended.map(d => {
                            return (
                    ...
                    pt-1 pb-1 bg-[rgb(53,84,114)] select-none">
                        <span className='mr-2 font-bold text-[15px]'>Others</span>
                        <span className='text-[14px] text-white leading-4'>{selectionType === 'sid' ? 'Departure ' : 'Arrival '}point fit but runways not fit</span>
                    </div>
                    {
                        otherRunway.map(d => {
                            return (
                    ...
                    pt-1 pb-1 bg-[rgb(53,84,114)] select-none">
                        <span className='mr-2 font-bold text-[15px]'>Others</span>
                        <span className='text-[14px] text-white leading-4'>Runway fit but {selectionType === 'sid' ? 'Departure ' : 'Arrival '}not fit</span>
                    </div>
                    {
                        otherEndPoint.map(d => {
                            return (
                    ...
                    pt-1 pb-1 bg-[rgb(53,84,114)] select-none">
                        <span className='mr-2 font-bold text-[15px]'>Others</span>
                        <span className='text-[14px] text-white leading-4'>Neither {selectionType === 'sid' ? 'Departure ' : 'Arrival '}point nor runway fit</span>
                    </div>
                    {
                        others.map(d => {
                            return (
                ...
                onClick={handleClose}>Cancel Selection</div>
            </div>
        </div>
        </>
    )
