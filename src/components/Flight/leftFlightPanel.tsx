        ...
        <>{
            ...
            <div className="relative w-full overflow-x-hidden overflow-y-auto flight-window-height">
                ...
                <div className="relative w-full h-[25px] flex justify-around items-center text-black select-none flight-link-status">
                    <div className="connected h-[24px] w-[120px] leading-[25px] text-center pl-[6px] pr-[6px] rounded-[12px]">Sync flight</div>
                    <div className={`${ownship || navlink ? 'connected' : 'disconnected'} h-[24px] w-[120px] leading-[25px] text-center pl-[6px] pr-[6px] rounded-[12px]`}>
                        {ownship || navlink ? 'Connected to ' : 'Unconnected to '}Ownship
                    </div>
                </div>
                <div className="relative flight-main-panel-border mt-[20px] text-white">
                    <div className="relative text-[15px] select-none font-bold">Planned route</div>
                    <div className="relative mt-1 bg-[#2b4f6e] rounded p-2 text-[14px]">
                        {data.route.route}
                    </div>
                </div>
                <div className="relative flight-main-panel-border mt-[20px] text-white">
                    <div className="relative text-[15px] select-none font-bold">Departure Airport</div>
                            ...
                            depWx !== 1 && (
                                <>
                                 <div className="relative weather-pill-info w-full mt-2 text-[15px] text-white flex flex-wrap justify-around items-center select-none">
                                    <Tooltip placement="top" title="QNH">
                                    ...
                                    <Tooltip placement="top" title="Wind">
                                    ...
                                    <Tooltip placement="bottom" title="Weather">
                    ...
                    {/* 起飞机场跑道和程序选择页面 */}
                    <div className="relative text-[15px] mt-1 font-bold select-none">Departure Procedure</div>
                    <div className='relative mt-1 bg-[#2b4f6e] rounded p-2'>
                        <div className="relative text-[14px] select-none">Departure runway</div>
                        {
                            depRwySelection ? 
                            depRwySelection !== 1 &&
                            <>
                                {/* 查看是否有已经选择的跑道，如有就显示跑道信息（文字&胶囊）， 否则就显示请选择字样，右侧有下拉选择框，这里面有跑道名称和一些基础信息， 下面的程序也同理 */}
                                {
                                    ...
                                    <div className="relative w-full mt-1 h-[40px] text-white flex justify-between">
                                        ...
                                        style={{color: depRwy ? `white` : `rgb(252,113,63)`}}>{
                                            depRwy ? depRwy.ident : `${depRwySelection.length} available`
                                        }</div>
                                    ...
                                    </div>
                                    {
                                        ...
                                        <div className="relative weather-pill-info w-full text-[15px] text-white flex flex-wrap justify-around items-center select-none">
                                            <Tooltip placement="top" title="Runway heading">
                                            ...
                                            <Tooltip placement="top" title="Runway width">
                                            ...
                                            <Tooltip placement="top" title="Runway length">
                        ...
                        {   <>
                            {
                                depRwy &&
                                <>
                                    <div className="relative text-[14px] mt-1 select-none">Departure procedure<ShowBeta text='beta' content='Draw route on map is still an experimental feature. Reference only' /></div>
                                {
                                    depProSelection ? 
                                        depProSelection !== 1 && 
                                        <>
                                            {
                                                ...
                                                <div className="relative w-full mt-1 h-[40px] text-white flex justify-between">
                                                    ...
                                                    style={{color: depPro ? `rgb(0,255,255)` : `rgb(252,113,63)`}}>{
                                                        depPro ? depPro.ident : `${depProSelection.length} available`
                                                    }</div>
                                                    <div className="action flex">
                                                ...
                                                </div>
                                                {
                                                    depPro && 
                                                    <div className="relative weather-pill-info w-full text-[15px] text-white flex flex-wrap justify-around items-center select-none">
                                                        <Tooltip placement="bottom" title="Departure airport">
                                                        ...
                                                        <Tooltip placement="bottom" title="Departure procedure">
                                                        ...
                                                        <Tooltip placement="bottom" title="Runways/transitions">
                    ...
                    <div className="relative text-[15px] mt-2 select-none font-bold">Arrival Airport</div>
                    <div className="relative mt-1 bg-[#2b4f6e] rounded p-2 select-none">
                    ...
                    {/* 降落机场跑道和程序选择页面 */}
                    <div className="relative text-[15px] mt-1 font-bold select-none">Arrival Procedure</div>
                    <div className='relative mt-1 bg-[#2b4f6e] rounded p-2'>
                        <div className="relative text-[14px] select-none">Landing runways</div>
                        {
                            arrRwySelection ? 
                            arrRwySelection !== 1 &&
                            ...
                            <>
                                {
                                    ...
                                    <div className="relative w-full mt-1 h-[40px] text-white flex justify-between">
                                        ...
                                        style={{color: arrRwy ? `white` : `rgb(252,113,63)`}}>{
                                            arrRwy ? arrRwy.ident : `${arrRwySelection.length} available`
                                        }</div>
                                        <div className="action flex">
                        ...
                        {arrRwy &&
                           <>
                                <div className="relative text-[14px] mt-1 select-none">Arrival Procedure<ShowBeta text='beta' content='Draw route on map is still an experimental feature. Reference only' /></div>
                                {
                                    arrProSelection ? 
                                        arrProSelection !== 1 && 
                                        <>
                                            {
                                                ...
                                                <div className="relative w-full mt-1 h-[40px] text-white flex justify-between">
                                                    ...
                                                    style={{color: arrPro ? `rgb(255,127,80)` : `rgb(252,113,63)`}}>{
                                                        arrPro ? arrPro.ident : `${arrProSelection.length} available`
                                                    }</div>
                                                    <div className="action flex">
                                                        {/* 这里改，事件和组件都改 */}
                        ...
                        {   arrRwy &&
                            <>
                                <div className="relative text-[14px] mt-1 select-none">Approach Procedure<ShowBeta text='beta' content='Draw route on map is still an experimental feature. Reference only' /></div>
                                {
                                    appProSelection ? 
                                        appProSelection !== 1 && 
                                        <>
                                            {
                                                ...
                                                <div className="relative w-full mt-1 h-[40px] text-white flex justify-between">
                                                    ...
                                                    style={{color: appProSelection ? `rgb(	255,105,180)` : `rgb(252,113,63)`}}>{
                                                        appPro ? formatAPPs(appPro.procedure, arrRwy.ident) : `${appProSelection.length} available`
                                                    }</div>
                                                    <div className="action flex">
                ...
                <div className="relative flight-main-panel-border mt-[20px] text-white">
                    <div className="relative text-[15px] select-none font-bold">Brief infomation</div>
                    <div className="relative mt-1 bg-[#2b4f6e] rounded p-2 text-[14px]">
                ...
                {/* {
                    (ownship || navlink) && 
                    <div className="relative flight-main-panel-border mt-[20px] text-white">
                        <div className="relative text-[15px] select-none font-bold">Flight info</div>
                        <div className="relative mt-1 bg-[#2b4f6e] rounded p-2 text-[14px]">
                            {
                                ownship && 
