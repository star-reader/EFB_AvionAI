          ...
          children: (
            <div className="relative base-1">
                <div className="relative m-2 text-white text-[16px] select-none">
                    <div className="relative ml-4">ICAO:  {arptInfo.icao}</div>
                </div>
                <div className="relative m-2 text-white text-[16px] select-none">
                    <div className="relative ml-4">Name:  {arptInfo.name}</div>
                </div>
                <div className="relative m-2 text-white text-[16px] select-none">
                    <div className="relative ml-4">Location  {LocationFormat(arptInfo.location.latitude, arptInfo.location.longtitude)}</div>
                </div>
                <div className="relative m-2 text-white text-[16px] select-none">
                    <div className="relative ml-4">Elevation:  {arptInfo.elevation}ft</div>
                </div>
                <div className="relative m-2 text-white text-[16px] select-none">
                    <div className="relative ml-4">Transition Altitude:  {arptInfo.transition_altitude}ft</div>
                </div>
                <div className="relative m-2 text-white text-[16px] select-none">
                    <div className="relative ml-4">Transition Level:  {arptInfo.transition_level}ft</div>
                </div>
                <div className="relative m-2 text-white text-[16px] select-none">
                    <div className="relative ml-4">Speed limit:  {arptInfo.speed_limit}knots</div>
                </div>
                <div className="relative m-2 text-white text-[16px] select-none">
                    <div className="relative ml-4">Speed limit altitude:  {arptInfo.speed_limit_altitude}ft</div>
                </div>
            </div>
          ),
        },
          ...
          <div className={`common-panel z-[22] absolute left-[50px] w-80 top-[50px] 
              ...
              >
                  ...
                  select-none phone:mt-[-30px] mb-[12px]">
                    {detail ? 'Detail Information' : 'Airport List'}
                  </div>
                  <div onClick={handleClose} className="absolute top-[4px] right-[16px] w-[60px] mt-[4px]
                        ...
                        cursor-pointer duration-200 hover:text-[#6084d9] phone:mt-[5px]">&lt;&nbsp;Back
                    </div>
                    {
                        !detail &&
                        <div onClick={() => setEditMode(!editMode)} className={`absolute top-[4px] left-[15px] mt-[4px] h-[20px]
                            ...
                            cursor-pointer phone:mt-[5px] pb-[2px] pl-[6px] pr-[6px] ${editMode ? 'edit-mode-exit' : 'edit-mode-enable'}`}>{editMode ? 'Exit edit mode' : 'Edit list'}
                        </div>
                    }
                      <Search placeholder="Search ICAO" onSearch={handleSearch} />
                      <div className="relative common-window-height w-full overflow-x-hidden overflow-y-auto">
                        {
                            ...
                            <Result
                              status="warning"
                              title="Airport info load failed, please try again"
                            /> :
