                            ...
                            <div className="relative">
                                {
                                            ...
                                            <div key={`${d.id}-${d.created_at}`} className="relative m-2 rounded-md bg-[#345476] p-3">
                                                ...
                                                <div className="flex justify-around items-center pt-2 pb-2">
                                                    ...
                                                    <div className="relative text-gray-300 text-[13px] select-none leading-[16px] width-calc-notam">
                                                        { d.created_at &&  <span>Created：2023-08-11 07:05 <br /></span>}
                                                        { d.effective_at && <span>Effective：2023-08-19 17:00 <br /></span>}
                                                        { d.expire_at && <span>Expire：2023-08-19 22:00</span>}
                                                    </div>
                                                </div>
                                            </div>
                                        )
                                    ...
                                    <Result
                                        status="warning"
                                        title="No NOTAM info available for this airport"
                                    />
                                }
                            </div>
                            :
